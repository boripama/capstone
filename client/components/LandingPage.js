          ...
          <div className="row">
            ...
            <div className="col-1-of-2">
              <div className="composition">
                ...
                <img src="/img/GPS1.png" alt="Photo 1" className="composition__photo composition__photo--p1" />
                <img src="/img/runners1.jpeg" alt="Photo 3" className="composition__photo composition__photo--p2" />
                <img src="/img/fitbit1.jpeg" alt="Photo 2" className="composition__photo composition__photo--p3" />
        ...
        <section className="section-stories">
          <div className="bg-video">
            <video className="bg-video__content" autoPlay muted loop>
              ...
              <source src="/videos/Park-Stroll/WEBM/Park-Stroll.webm" type="video/webm" />
