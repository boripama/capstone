...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({ email: 'cody@email.com', password: '123', zip: 12345 }),
    User.create({ email: 'zeke@email.com', password: '123', zip: 12345 }),
    User.create({ email: 'murphy@email.com', password: '123', zip: 12345 })
  ]);
